...
class EmailsController extends AbstractController
{
    ...
    {
        return $this->render('emails/index.html.twig', ['emails' => $emailsRepository->findAll()]);
    }
    ...
    {
        return $this->render('emails/show.html.twig', ['email' => $email]);
    }
    ...
    public function edit(Request $request, Emails $email): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('emails_edit', ['id' => $email->getId()]);
        }
