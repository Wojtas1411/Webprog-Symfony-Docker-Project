...
class MembershipController extends AbstractController
{
    ...
    {
        return $this->render('membership/index.html.twig', ['memberships' => $membershipRepository->findAll()]);
    }
    ...
    {
        return $this->render('membership/show.html.twig', ['membership' => $membership]);
    }
    ...
    public function edit(Request $request, Membership $membership): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('membership_edit', ['id' => $membership->getId()]);
        }
